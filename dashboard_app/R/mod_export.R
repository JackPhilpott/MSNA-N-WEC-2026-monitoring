  ...
  nav_panel(
    ...
    layout_columns(
      ...
      card(
        ...
        p(class = "text-muted", "Every submission-level column currently in scope (respects all sidebar filters) — every raw submission, including consent refusals and duplicate copies. This is a larger number than \"Achieved\" elsewhere in the dashboard (e.g. Home), which counts only completed, non-duplicate interviews. Respondent-identifying fields (age/gender/household size/exact GPS) are excluded — see the Sample Representativeness tab for the same information in aggregate."),
